...
plot(prep, 
     ...
     custom.labels = c("Employment", "Feelings", "Health and Fertility","Family Law", "Private Finances", "Politics",  "Childbirth", "Child Abuse"),
...
prep2<- estimateEffect(c(17) ~ Mother*Year , PrevFit, meta= out$meta, uncertainty="None") 

plot(prep2, covariate = "Year", method = "continuous", model = PrevFit, printlegend = F, moderator="Mother", moderator.value="TRUE", linecol = "blue", ylim=c(0.00, 0.12), main="Childbirth Topic Prevalence") ;  plot(prep2, covariate = "Year", method = "continuous",  model = PrevFit, printlegend = F, moderator="Mother", moderator.value="FALSE", linecol = "red", add = T)
...
legend(0, 0.03, c("Mother", "Father"), lwd=2, col=c("blue", "red"))
...
plot(prep, 
     covariate = "Newspaper", 
     topics = c(2, 3, 5, 6, 9, 10, 11, 14, 17,18),
     model = PrevFit,
     method = "difference", 
     cov.value1 = "The Times", cov.value2 = "The Guardian",
     main = "Prevalence of Topics in different Nespapers ",
     xlim=c(-0.1, 0.1), labeltype = "custom",
     custom.labels = c("Employment", "Royal Family", "Feelings", "Health and Fertility","Family Law", "Private Finances", "Celebrities", "Politics",  "Childbirth", "Child Abuse"),
    xlab="More  prevalent in Daily Mail              More prevalent in The Guardian")   
```

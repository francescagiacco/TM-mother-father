...
plot(prep2, covariate = "Year", method = "continuous", model = PrevFit, printlegend = F, moderator="Mother", moderator.value="TRUE", linecol = "blue", ylim=c(0.02, 0.10), main="Crimes/Court Topic Prevalence") ;  plot(prep2, covariate = "Year", method = "continuous",  model = PrevFit, printlegend = F, moderator="Mother", moderator.value="FALSE", linecol = "red", add = T)
